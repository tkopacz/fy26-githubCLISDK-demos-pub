...
/// Zmienne już ustawione w środowisku mają pierwszeństwo (nie są nadpisywane).
/// </summary>
public static class DotEnvLoader
{
    ...
    /// <summary>
    /// Wczytuje plik .env (jeśli istnieje). Bezpieczne do wielokrotnego wywołania — ładuje tylko raz.
    /// </summary>
    ...
    {
        // Szukamy .env wychodząc w górę od katalogu binarki
